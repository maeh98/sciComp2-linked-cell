...
class Cell_2(Cell):
    ...
    def p2p_self(self):
        ...
        for particle in self.particle_list:    
            for other_particle in self.particle_list:   
                ...
                if distance > 1e-16:    # Check they are not the same
    ...
    def p2p_neigbor_cells(self, list_cells):
        ...
        particles_outside_cell = []      # Store all particles of neighbor cells.
        ...
        for particle in self.particle_list:
            for other_particle in particles_outside_cell:
                # loop through particles in neighboring cell list.
                distance = particle.distance(other_particle)
                if distance > 1e-16:    # Check it's not the same particle.
                    particle.phi += utils.lj_potential(distance)
